sap.ui.define([
	...
	function toStep2 (oEvent){
		//Step 1
		var dataEmployeeStep = this.byId("Step2");
		//Step 2
	...
	function wizardCompletedHandler(oEvent){
		...
		this.dataEmployeeValidation(oEvent,function(isValid){
			if(isValid){
				...
				this._wizard.goToStep(this.byId("Step2"));
			}
		}.bind(this));
	}
	...
	return Controller.extend("proyectofinal.controller.CrearEmpleado", {  
